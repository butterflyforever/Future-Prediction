...
def EB_NN(data_path, result_path, n_epoch, input_dim):
    ...
    f = open("../data/all/1000/model/BoW_NN_result.txt", 'a')
...
if __name__ == '__main__':
    ...
    data_path = "../data/all/1000/model/dayemb/BoW_%s.pickle"
    # result_path = "../data/all/1000/model/hdf5/ONE_EB_NN/EB_NN_%s.hdf5"
    result_path = "../data/all/1000/model/hdf5/BoW_NN/BoW_NN_%s.hdf5"
    PRICE_PATH = "../data/all/price.txt"
    count_res_path = "../data/all/1000/model/BoW_NN_result.txt"
    ...
    for i, product in enumerate(products):
        print("BoW_NN No.%d, %s" % (i, product))
        logging.info("BoW_NN No.%d, %s" % (i, product))
        # product = 'JM'
        try:

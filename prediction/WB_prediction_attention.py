...
def WB_ATT(data_path, result_path, n_epoch, input_dim, product):
    # load data
    ...
    f = open("../data/all/1000/model/ONE_WB_Attention_result.txt", 'a')
...
if __name__ == '__main__':
    ...
    result_path = "../data/all/1000/model/hdf5/ONE_WB_ATT/WB_ATT_%s.hdf5"
    PRICE_PATH = "../data/all/price.txt"
    count_res_path = "../data/all/1000/model/ONE_WB_Attention_result.txt"
    # Train all products
    ...
    for i, product in enumerate(products):
        ...
        # product = 'JM'
        try:
            WB_ATT(data_path % product, result_path % product, n_epoch, input_dim, product)
            # break

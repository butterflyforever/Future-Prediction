...
class RoleDependentLayer(object):
    def __init__(self, left_dependent, right_dependent, rng,
        ...
        if trainedParams[name]["T"] is not None:
            ...
            self.T = theano.shared(value=np.asarray(trainedParams[name]["T"], theano.config.floatX),
        ...
        if trainedParams[name]["W1"] is not None:
            ...
            self.W1 = theano.shared(value=np.asarray(trainedParams[name]["W1"],theano.config.floatX),
        ...
        if trainedParams[name]["W2"] is not None:
            ...
            self.W2 = theano.shared(value=np.asarray(trainedParams[name]["W2"],theano.config.floatX),
        ...
        if trainedParams[name]["b"] is not None:
            ...
            self.b = theano.shared(value=np.asarray(trainedParams[name]["b"],theano.config.floatX),
